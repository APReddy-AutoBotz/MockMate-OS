  ...
  it('38. Valid challenge + recovery turns generate challengeRecoveryTimeline', async () => {
    const history = [
      ...
      },
      {
        ...
        interviewer: 'Alex',
        rootQuestionId: 'q1',
        questionKind: 'challenge' as const,
        challengeEvent: {
          id: 'ce-1',
          type: 'counterargument' as const,
          prompt: 'What if disk write latency surges?',
          text: 'What if disk write latency surges?',
          targetDimensions: ['SYSTEMS_THINKING' as const],
          rationale: 'Testing candidate resilience to disk latency spikes.',
          triggeringTurnId: '11111111-1111-1111-1111-111111111111',
      ...
      },
      {
        ...
        interviewer: 'Alex',
        rootQuestionId: 'q1',
        questionKind: 'reflection' as const,
