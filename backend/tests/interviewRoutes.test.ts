  ...
  it('38. Valid challenge + recovery turns generate challengeRecoveryTimeline', async () => {
    const history = [
      ...
      },
      {
        ...
        challengeEvent: { triggeringTurnId: '11111111-1111-1111-1111-111111111111', stage: 'exploration' as const, severity: 'medium' as const, type: 'counterargument' as const, text: 'What if disk write latency surges?' },
